...
<p align="center">
  ...
  <a href="https://supabase.com"><img src="https://img.shields.io/badge/SUPABASE-REALTIME-3ECF8E?style=for-the-badge&logo=supabase&logoColor=white" alt="Supabase"></a>
...
```mermaid
graph LR
    subgraph "Neural Interface (Frontend)"
        A[Flutter UI] --> B[Provider Flow]
        B --> C[Background Sync]
    end
    
    subgraph "Central Core (Backend)"
        D[(Supabase DB)]
        E[(Supabase Storage)]
        F{Firebase Sentinel}
    end
